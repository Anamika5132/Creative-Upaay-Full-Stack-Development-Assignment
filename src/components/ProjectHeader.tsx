    ...
    <div className="space-y-4 mb-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          {/* Invite Button */}
          <Button className="bg-primary hover:bg-primary/90 text-white gap-2 px-6 flex items-center">
          ...
          <div className="flex -space-x-2 items-center">
            ...
            <div className="w-10 h-10 rounded-full border-2 border-white bg-[#F4D7DA] text-[#D25B70] flex items-center justify-center text-sm font-medium">
              +2
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3 flex-wrap flex-1">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onDueDateChange(value === "all" ? null : value)
            }
          >
            <SelectTrigger className="w-[140px]">
